...
<div id="customAlert" class="custom-toast position-fixed top-0 end-0 m-4" style="z-index: 1050;">
    <div class="toast-body d-flex align-items-center shadow-lg rounded-3 px-4 py-3" style="background: rgba(255, 18, 18, 0.85); color: white; backdrop-filter: blur(10px); border-left: 5px solid #fff;">
